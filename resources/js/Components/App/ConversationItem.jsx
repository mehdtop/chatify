...
const ConversationItem = ({
    ...
    return(
        ...
        preserveState
        className={
            "conversation-item flex border-l-4 items-center gap-2 p-2 text-gray-300 transition-all cursor-pointer border-1-4 hover:bg-black/30 "
            + classes +
                ...
                <div className="flex gap-1 justify-between items-center">
                    ...
                    {conversation.last_message_date && (
                        <span className="text-nowrap">
                            {formatMessageDate(conversation.last_message_date,true)}
                        </span>
                    )}
                </div>
